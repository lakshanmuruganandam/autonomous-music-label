...
git clone https://github.com/lakshanmuruganandam/autonomous-music-label.git
cd autonomous-music-label
...
### 🧠 Preferred Model
> `facebook/musicgen-large` — Neural audio and music generation.
